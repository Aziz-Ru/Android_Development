...
public class Init_Commit extends AppCompatActivity {
AppBarLayout appBarLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_init_commit);
        Toolbar init_toolbar=findViewById(R.id.toolbar_init);
        appBarLayout=findViewById(R.id.layout_init);
        init_toolbar.setTitle("Git Init,add ও Commit এর পরিচিতি");
        setSupportActionBar(init_toolbar);
